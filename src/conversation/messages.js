...
function list(body, rows, buttonText = "Select") {
  return { kind: "list", body, buttonText, sections: [{ title: "Options", rows }] };
}
...
function languageMessage() {
  return buttons("Please select your language.\nبراہِ کرم اپنی زبان منتخب کریں۔", [
...
function mainMenu(language) {
  return list(tr(language, "welcome"), [
